...
const primaryActions = [
  ...
  {
    label: "Save in USD",
    description: "Deposit USDC and earn ~4% APY in the yield vault",
    href: "/earn",
    icon: PiggyBank,
            ...
            <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24 md:pt-28 md:pb-32">
              <div className="max-w-2xl">
                ...
                <p className="text-lg md:text-xl text-muted-foreground mt-6 max-w-lg leading-relaxed animate-fade-up stagger-2">
                  ...
                  <span className="text-success font-medium">~4% APY</span>{" "}
        ...
        <section className="max-w-6xl mx-auto px-6 pb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard
              ...
              value={isConnected ? `$${formatUSDC(assetsValue)}` : "$0.00"}
              change={isConnected && assetsValue ? "earning ~4% APY" : undefined}
              icon={PiggyBank}
              accent
              delay="stagger-1"
            />
            <StatCard
              label="USDC wallet"
              value={isConnected ? `$${formatUSDC(usdcBalance)}` : "$0.00"}
              icon={DollarSign}
              delay="stagger-2"
            />
            <StatCard
            ...
            <Card className="animate-fade-up card-hover overflow-hidden stagger-4 border-success/20">
              <CardContent className="pt-6 relative">
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-1">
                    <p className="text-sm text-muted-foreground">Savings APY</p>
                    <div className="animate-count-up">
                      <p className="text-2xl md:text-3xl font-display tracking-tight">
                        ~4.00%
                      </p>
                      <p className="text-xs text-success font-medium mt-1">Curve + Superlend</p>
                    </div>
                  </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
                {[
                  ...
                  {
                    step: "02",
                    title: "Save in USD, earn 4%",
                    desc: "Your USDC sits in a yield vault earning ~4% APY. No lock-ups. Withdraw anytime. Stop losing value to local currency depreciation.",
                    icon: TrendingUp,
                  },
                  {
                    step: "03",
          ...
          <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <div className="size-5 rounded bg-foreground flex items-center justify-center">
                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" className="text-background">
